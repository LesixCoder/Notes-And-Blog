...
- [awesome-gulp（star 569）](https://github.com/alferov/awesome-gulp)
...
- [Go语言构建Web应用（star 35.5k）](https://github.com/astaxie/build-web-application-with-golang/blob/master/zh/preface.md)
- [Go 入门指南（star 22.7k）](https://github.com/Unknwon/the-way-to-go_ZH_CN)
...
- [Go 学习之路：Go 开发者博客、Go 微信公众号、Go 学习资料（文档、书籍、视频）（star 824）](https://github.com/yangwenmai/learning-golang)
...
- [谷粒-Chrome插件英雄榜（star 16.9k）](https://github.com/zhaoolee/ChromeAppHeroes)
- [Jeecg-Boot 快速开发平台-基于代码生成器的低代码开发平台（star 14.7k）](https://github.com/zhangdaiscott/jeecg-boot)
- [《Chrome插件开发全攻略》（star 4.7k）](https://github.com/sxei/chrome-plugin-demo)
- [开源运维平台：面向中小型企业设计的无 Agent的自动化运维平台（star 4.1k）](https://github.com/openspug/spug)
...
- Github
  ...
  - [berwin刘博文的个人博客（star 3k）](https://github.com/berwin/Blog)
  ...
  - [前端学习资料合集（包含深入解读JS系列，React、Vue源码分析，前端算法解析，收集大厂面经，前端工程化最佳实践，经典图书分享，推荐好用的前端工具等等，内容不定期更新中。一边记录，一边学习，一边分享）（star 539）](https://github.com/fyuanfen/note)
  - [JavaScript 学习 — 完全整理（star 418）](https://github.com/csxiaoyaojianxian/JavaScriptStudy)
  - [若川的博客—前端视野-资源和源代码vuepress 博客（star 143）](https://github.com/lxchuan12/blog)
...
- [技术面试手册（star 44.4k）](https://github.com/yangshun/tech-interview-handbook)
- [🥇掘金翻译计划，可能是世界最大最好的英译中技术社区，最懂读者和译者的翻译平台（star 26.9k）](https://github.com/xitu/gold-miner)
- [前端面试每日 3+1（star 13k）](https://github.com/haizlin/fe-interview)
- [前端入门和进阶学习笔记（star 12.2k）](https://github.com/qianguyihao/Web)
...
- [前端乐园（star 982）](https://github.com/abc-club/js-paradise)
- [前端面试星球（star 907）](https://github.com/lgwebdream/FE-Interview)
