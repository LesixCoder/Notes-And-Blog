...
- [x] [面向对象的 JS](/post/设计模式与开发实践/面向对象的JS.md)

- 创建型设计模式
  - [x] [简单工厂模式](/post/设计模式与开发实践/01.创建型设计模式/简单工厂模式.md)
  - [x] [工厂方法模式](/post/设计模式与开发实践/01.创建型设计模式/工厂方法模式.md)
  - [x] [抽象工厂模式](/post/设计模式与开发实践/01.创建型设计模式/抽象工厂模式.md)
  - [x] [建造者模式](/post/设计模式与开发实践/01.创建型设计模式/建造者模式.md)
  - [x] [原型模式](/post/设计模式与开发实践/01.创建型设计模式/原型模式.md)
  - [x] [单例模式](/post/设计模式与开发实践/01.创建型设计模式/单例模式.md)
- 结构型设计模式
  - [x] [外观模式](/post/设计模式与开发实践/02.结构型设计模式/外观模式.md)
  - [x] [适配器模式](/post/设计模式与开发实践/02.结构型设计模式/适配器模式.md)
  - [x] [代理模式](/post/设计模式与开发实践/02.结构型设计模式/代理模式.md)
  - [x] [装饰者模式](/post/设计模式与开发实践/02.结构型设计模式/装饰者模式.md)
  - [x] [桥接模式](/post/设计模式与开发实践/02.结构型设计模式/桥接模式.md)
  - [x] [组合模式](/post/设计模式与开发实践/02.结构型设计模式/组合模式.md)
  - [x] [享元模式](/post/设计模式与开发实践/02.结构型设计模式/享元模式.md)
- 行为型设计模式
  - [x] [模板方法模式](/post/设计模式与开发实践/03.行为型设计模式/模板方法模式.md)
  - [x] [观察者模式](/post/设计模式与开发实践/03.行为型设计模式/观察者模式.md)
  - [x] [状态模式](/post/设计模式与开发实践/03.行为型设计模式/状态模式.md)
  - [x] [策略模式](/post/设计模式与开发实践/03.行为型设计模式/策略模式.md)
  - [x] [职责链模式](/post/设计模式与开发实践/03.行为型设计模式/职责链模式.md)
  - [x] [命令模式](/post/设计模式与开发实践/03.行为型设计模式/命令模式.md)
  - [x] [访问者模式](/post/设计模式与开发实践/03.行为型设计模式/访问者模式.md)
  - [ ] 中介者模式
  - [ ] 备忘录模式
  - [ ] 迭代器模式
  - [ ] 解释器模式
...
- [TypeScript 入门教程（star 6.9k）](https://github.com/xcatliu/typescript-tutorial)
- [TypeScript 使用手册（star 4.1k）](https://github.com/zhongsp/TypeScript)
- [深入理解 TypeScript（star 3.3k）](https://github.com/jkchao/typescript-book-chinese)

#### 🦎Vue

- [Vue.js 源码解析（star 9.8k）](https://github.com/answershuto/learnVue)
- [vue-design逐行级别的源码分析（star 5.1k）](https://github.com/HcySunYang/vue-design)
- [vue源码逐行注释分析+40多m的vue源码程序流程图思维导图（2.4k）](https://github.com/qq281113270/vue)
...
- react
  ...
  - [react+typescript备忘（star 17.2k）](https://github.com/typescript-cheatsheets/react-typescript-cheatsheet)
  - [React 开发者指南（star 14.8k）](https://github.com/adam-golab/react-developer-roadmap/blob/master/README-CN.md)
  - [排名前500位ReactJS面试问题与答案的列表...编码练习问题即将推出！（star 7.9k）](https://github.com/sudheerj/reactjs-interview-questions)
  ...
  - [React技术揭秘（star 1.6k）](https://github.com/BetaSu/just-react)
...
- Flutter
  - [Flutter 超完整的开源项目，功能丰富，适合学习和日常使用（star 11.4k）](https://github.com/CarGuo/gsy_github_app_flutter)
...
- [Python - 100天从新手到大师（star 92.5k）](https://github.com/jackfrued/Python-100-Days)
...
- [Go语言构建Web应用（star 35.6k）](https://github.com/astaxie/build-web-application-with-golang/blob/master/zh/preface.md)
- [Go 入门指南（star 22.9k）](https://github.com/Unknwon/the-way-to-go_ZH_CN)
...
- [Go 学习之路：Go 开发者博客、Go 微信公众号、Go 学习资料（文档、书籍、视频）（star 846）](https://github.com/yangwenmai/learning-golang)
...
- [谷粒-Chrome插件英雄榜（star 17k）](https://github.com/zhaoolee/ChromeAppHeroes)
- [Jeecg-Boot 快速开发平台-基于代码生成器的低代码开发平台（star 14.9k）](https://github.com/zhangdaiscott/jeecg-boot)
- [《Chrome插件开发全攻略》（star 4.7k）](https://github.com/sxei/chrome-plugin-demo)
- [开源运维平台：面向中小型企业设计的无 Agent的自动化运维平台（star 4.3k）](https://github.com/openspug/spug)
...
- [微前端的那些事儿（star 2.3k）](https://github.com/phodal/microfrontends)
...
- Github
  ...
  - [张云龙（21k）](https://github.com/fouber/blog)
  - [冴羽（star 19.8k）](https://github.com/mqyqingfeng/Blog)
  - [马云云在Github的学习片段（star 11.1k）](https://github.com/markyun/My-blog)
  - [木易杨，公众号「高级前端进阶」（star 8.6k）](https://github.com/yygmind/blog)
  - [关注基础知识，打造优质前端博客，公众号[前端工匠]（star 5.6k）](https://github.com/ljianshu/Blog)
  - [梁少峰的个人博客（star 4.4k）](https://github.com/youngwind/blog)
  - [大前端的瑞士军刀，只记录有用的（star 4.1k）](https://github.com/nieweidong/fetool)
  - [前端小智-每年至少会分享不少于200篇的优质文章（star 3.3k）](https://github.com/qq449245884/xiaozhi)
  - [berwin刘博文的个人博客（star 3.1k）](https://github.com/berwin/Blog)
  - [蚂蚁数据体验技术团队（star 2.4k）](https://github.com/ProtoTeam/blog)
  - [Jony的博客，记录学习工作的点点滴滴（star 1.6k）](https://github.com/forthealllight/blog)
  ...
  - [前端学习资料合集（包含深入解读JS系列，React、Vue源码分析，前端算法解析，收集大厂面经，前端工程化最佳实践，经典图书分享，推荐好用的前端工具等等，内容不定期更新中。一边记录，一边学习，一边分享）（star 541）](https://github.com/fyuanfen/note)
  - [JavaScript 学习 — 完全整理（star 419）](https://github.com/csxiaoyaojianxian/JavaScriptStudy)
  - [若川的博客—前端视野-资源和源代码vuepress 博客（star 147）](https://github.com/lxchuan12/blog)
...
- [技术面试手册（star 44.6k）](https://github.com/yangshun/tech-interview-handbook)
- [🥇掘金翻译计划，可能是世界最大最好的英译中技术社区，最懂读者和译者的翻译平台（star 27k）](https://github.com/xitu/gold-miner)
- [前端面试每日 3+1（star 13.2k）](https://github.com/haizlin/fe-interview)
- [前端入门和进阶学习笔记（star 12.3k）](https://github.com/qianguyihao/Web)
