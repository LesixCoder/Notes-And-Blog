...
- [技术面试必备基础知识、Leetcode、计算机操作系统、计算机网络、系统设计、Java、Python、C++（star 104k）](https://github.com/CyC2018/CS-Notes)
- [JavaScript 算法与数据结构（star 73.7k）](https://github.com/trekhleb/javascript-algorithms/blob/master/README.zh-CN.md)
- [用动画的形式呈现解LeetCode题目的思路（star 56k）](https://github.com/MisterBooo/LeetCodeAnimation)
- [手把手撕LeetCode题目，扒各种算法套路的裤子（star 46.3k）](https://github.com/labuladong/fucking-algorithm)
- [leetcode 题解（star 30.8k）](https://github.com/azl397985856/leetcode)
...
- [和小浩学算法（star 5k）](https://github.com/geekxh/hello-algorithm)
