...
- [Go语言构建Web应用（star 35.7k）](https://github.com/astaxie/build-web-application-with-golang/blob/master/zh/preface.md)
- [Go 入门指南（star 23.1k）](https://github.com/Unknwon/the-way-to-go_ZH_CN)
...
- [Go 学习之路：Go 开发者博客、Go 微信公众号、Go 学习资料（文档、书籍、视频）（star 855）](https://github.com/yangwenmai/learning-golang)
